...
public class AdminController {
    ...
    public String showUserInfo(@PathVariable("id") Long id, Model model, @AuthenticationPrincipal Client user) {
        ...
        List<Product> products = adminService.findAllClientProducts(client);
    ...
    @GetMapping("/users")
    public String showUsers(@RequestParam(name = "email", required = false) String email, Model model) {
